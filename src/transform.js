...
function Transform(name, start) {
    ...
    if (start && start.equals) {
        this.equals = (va, vb) => va.equals(vb)
    }
    else {
        this.equals = (va, vb) => va === vb
    }
    ...
    Object.defineProperty(this, "invertible", {
        get() { return invertible; },
        set(inv) { if (inv !== undefined) invertible = !!inv; }
    });
}
...
EditStack.prototype = {
    ...
    undo() {
        ...
        const entry = this.history[this.pos--];
