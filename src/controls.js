...
const Controls = function(camera, domElement, params) {
    this.objects = [];
    this.camera = camera;
    ...
    function onMouseMove({clientX, clientY}) {
        ...
        mouseXprev = mouseX;
        mouseYprev = mouseY;
        mouseX = (clientX / _this.domElement.offsetWidth) * 2 - 1;
        mouseY = (clientY / _this.domElement.offsetHeight) * 2 - 1;
    ...
    function onMousewheel({wheelDelta, detail}) {
        const d = ((typeof wheelDelta !== "undefined")?(-wheelDelta):(detail));
        handleWheel(d);
    }
