...
const Markers = (() => {
    ...
    Object.assign(Marker.prototype, {
        ...
        scaleFromPoint: (() => {
            const vfactor = new THREE.Vector3();
    ...
    Markers.SphereMarker = function(params = {}) {
        ...
        const heightSegments = params.heightSegments || 8;

        const geo = new THREE.SphereBufferGeometry(radius, widthSegments, heightSegments);
        const mat = params.material ? params.material.clone() : new THREE.MeshStandardMaterial({
    ...
    Object.assign(Markers.PlaneMarker.prototype, {
        ...
        setFromBoundingBox: (() => {
            ...
            return function(boundingBox, overflowFactor = 1) {
    ...
    Markers.PointerMarker = function(params = {}) {
        ...
        const coneBufferGeo = new THREE.ConeBufferGeometry(1, 4.0, segments);
        coneBufferGeo.rotateX(Math.PI / 2);
        coneBufferGeo.translate(0, 0, 4.0);
        const sphereBufferGeo = new THREE.SphereBufferGeometry(1, segments, segments / 2);
